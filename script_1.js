            ...
            <div class="geco-wrap">
                <div class="geco-main">
                    <div class="geco-header-bar">
                        <span>System</span>
                        <span style="color:#fbbf24; background:#78350f; padding:2px 6px; border-radius:2px; margin-left:10px; font-size:9px; border:1px solid #b45309;">SIMULATION MODE (NO HARDWARE IP)</span>
                        <span style="flex:1; text-align:right;">MultiChannel High Voltage System</span>
                    </div>
